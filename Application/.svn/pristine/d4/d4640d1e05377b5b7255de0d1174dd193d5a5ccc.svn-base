...
$time = venus_script_begin("新SKU销售量排行榜(周)");
//周
...
$fname = "SKU销量排行榜";
$header = array("二级分类", "一级分类销量排名", "sku编号", "sku名称", "sku规格", "sku计量单位", "销售总量", "销售总额", "采购总额", "毛利", "毛利率");
